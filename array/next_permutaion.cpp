...
public:
    void nextPermutation(vector<int> &nums)
    {
        ...
        */
        ...
        // step 1: Linearly traverse given array from the end and find a number that is greater than its adjacent nums[i] > nums[i-1]. Store the index-1 of smaller number in breakPoint variable. If there is no such element, reverse entire array and return.
